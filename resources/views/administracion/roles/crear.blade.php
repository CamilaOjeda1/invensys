        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form action="{{ route('roles.lista') }}" method="POST">
                  @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="rol" name="rol" class="form-control" id="rol" placeholder="ingresar rol" maxlength="50" >
                </div>
                <div class="row mt-3 justify-content-center">
                    ...
                    <div class="col-2 d-flex justify-content-center">
                      <a href="{{ route('roles.lista') }}" class="btn btn-primary btn-block">Volver</a>
                    </div>
                  </div>
              </form>
              </div>
